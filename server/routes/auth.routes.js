...
router.post("/signup", (req, res, next) => {
    ...
    //Check if the email/password/name are providing empty strings
    ...
    if (!passwordRegex.test(password)) {
        res.status(400).json({message: "Password must have at least 6 characters and at least 1 number"})
        return;
    }
